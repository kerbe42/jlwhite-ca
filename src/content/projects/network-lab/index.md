...
It's also the bench that carried me through my CCNA and CCNP. I labbed the exam topics on real gear instead of memorizing them, and that is why they stuck.
...
What it taught me stayed. Understanding how a frame actually moves across a switch, or how a routing table converges, makes the virtual networking in the [current lab](/lab/home-lab-overview) feel like the same ideas at a different layer: bridges instead of trunk ports, an HA firewall pair instead of a single edge router. This rack taught me what the abstractions are standing on.
...
I built it after watching Google's **[Hacking Google](https://www.youtube.com/watch?v=TusQWn2TQxQ)** series, specifically the Red Team episode. To get into the Google Glass project, their red team left **USB plasma globes preloaded with malware** around campus and waited. Someone plugged one in, and that became the foothold for a chain of infections that reached confidential project data. They got almost everything; the way the episode tells it, what eventually gave them away was a spelling mistake in one of their own emails. The plasma globe here is a nod to that story.

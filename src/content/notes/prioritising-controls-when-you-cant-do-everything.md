...
Every security program is under-resourced relative to its threat model — that's not a failure, it's the permanent condition. So the actual skill isn't knowing the controls; it's sequencing them when you can only do a fraction this year. Here's how I'd reason about it, kept generic.

...
date: 2026-06-12
summary: 'The naïve version of security leadership is a list of controls. The real version is a negotiation with a business that does not stop — and a bypassed control is worse than no control.'
kind: essay
tags: ['leadership', 'risk', 'security-program']
draft: false
---

The naïve version of security leadership is a list of controls. The real version is a negotiation with a business that does not stop.
